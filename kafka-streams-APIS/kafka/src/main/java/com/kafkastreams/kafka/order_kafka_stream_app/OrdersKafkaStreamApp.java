package com.kafkastreams.kafka.order_kafka_stream_app;
...
public class OrdersKafkaStreamApp {
    ...
    public static void main(String[] args) {
        ...
        //config.put(StreamsConfig.NUM_STREAM_THREADS_CONFIG,Runtime.getRuntime().availableProcessors());// read only the new messages

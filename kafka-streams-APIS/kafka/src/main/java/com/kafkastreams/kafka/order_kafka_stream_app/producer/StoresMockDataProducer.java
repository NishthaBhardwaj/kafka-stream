package com.kafkastreams.kafka.order_kafka_stream_app.producer;

import static com.kafkastreams.kafka.order_kafka_stream_app.producer.ProducerUtil.publishMessageSync;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.kafkastreams.kafka.order_kafka_stream_app.domain.Address;
import com.kafkastreams.kafka.order_kafka_stream_app.domain.Store;
import com.kafkastreams.kafka.order_kafka_stream_app.topology.OrdersTopology;
